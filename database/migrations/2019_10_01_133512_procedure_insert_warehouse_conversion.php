...
class ProcedureInsertWarehouseConversion extends Migration
{
    ...
    public function up()
    {
        ...
        BEGIN
        INSERT INTO trx_warehouse_conversion (list_proc_detail_id, procurement_no, qty_proc, uom_proc, qty_konversi, uom_konversi, created_at, created_by) VALUES (list_proc_detail_id, procurement_no, qty_proc, uom_proc, qty_konversi, uom_konversi, now(), created_by);
        END');
    }
