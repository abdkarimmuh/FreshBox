...
class ProcedureUpdateDeliveryOrderDetail extends Migration
{
    ...
    public function up()
    {
        ...
        BEGIN
        UPDATE master_delivery_order_detail SET delivery_order_id = delivery_order_id, item_id = item_id, sales_order_detail_id = sales_order_detail_id, qty_do = qty_do, uom_id = uom_id, updated_by = updated_by, updated_at = now() WHERE id = v_id;
        END');
    }
