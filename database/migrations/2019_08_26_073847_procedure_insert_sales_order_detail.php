...
class ProcedureInsertSalesOrderDetail extends Migration
{
    ...
    public function up()
    {
        ...
        BEGIN
        INSERT INTO trx_sales_order_detail (sales_order_id, skuid, uom_id, qty, amount_price, tax_value, total_amount, notes, status, created_at, created_by) VALUES (sales_order_id, skuid, uom_id, qty, amount_price, tax_value, total_amount, notes, status, now(), created_by);
        END');
    }
