...
class ProcedureUpdateItem extends Migration
{
    ...
    public function up()
    {
        ...
        DB::unprepared('CREATE PROCEDURE update_item(IN skuid INT, IN name_item VARCHAR(191), IN name_item_latin VARCHAR(191), IN description VARCHAR(191), IN is_trf_item VARCHAR(191), IN category_id INT, IN uom_id INT, IN origin_id INT, IN tax FLOAT, IN updated_by INT )
        BEGIN
