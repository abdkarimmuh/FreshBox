...
class ProcedureUpdateSalesOrder extends Migration
{
    ...
    public function up()
    {
        ...
        BEGIN
        UPDATE master_sales_order SET sales_order_no = sales_order_no, source_order_id = source_order_id, customer_id = customer_id, fulfillment_date = fulfillment_date, remarks = remarks, status = status, file = file, updated_by = updated_by, updated_at = now() WHERE id = v_id;
        END');
    }
