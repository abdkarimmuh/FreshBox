...
class ProcedureInsertSalesOrder extends Migration
{
    ...
    public function up()
    {
        ...
        DB::unprepared('CREATE PROCEDURE insert_sales_order( IN sales_order_no VARCHAR(20), IN source_order_id INT, IN customer_id INT, IN fulfillment_date DATE, IN remarks VARCHAR(191), IN status INT, IN created_by INT )
        BEGIN
