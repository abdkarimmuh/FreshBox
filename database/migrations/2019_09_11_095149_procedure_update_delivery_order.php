...
class ProcedureUpdateDeliveryOrder extends Migration
{
    ...
    public function up()
    {
        ...
        BEGIN
        UPDATE master_delivery_order SET delivery_order_no = delivery_order_no, sales_order_id = sales_order_id, customer_id = customer_id, do_date = do_date, confrim_date = confrim_date, driver_id = dricer_id, updated_by = updated_by, updated_at = now() WHERE id = v_id;
        END');
    }
