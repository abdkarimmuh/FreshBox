<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="dropdown {{ request()->segment(1) == 'marketing' ? ' active' : '' }}">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-bullhorn"></i><span>Marketing</span></a>
            <ul class="dropdown-menu">
                <li class="{{ request()->route()->getName() == 'marketing.form_sales_order' ? ' active' : '' }}">
                    <a class="nav-link" href="{{ route('marketing.form_sales_order') }}"><span>Form Sales Order</span></a>
                </li>
            </ul>
        </li>
        <li class="dropdown {{ request()->segment(1) == 'warehouse' ? ' active' : '' }}">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-warehouse"></i><span>Warehouse</span></a>
            <ul class="dropdown-menu">
                <li class="{{ request()->route()->getName() == 'warehouse.form_delivery_order' ? ' active' : '' }}">
                    <a class="nav-link" href="{{route('warehouse.form_delivery_order')}}"><span>Form Delivery Order</span></a>
                </li>
                <li class="{{ request()->route()->getName() == 'warehouse.confirm_delivery_order' ? ' active' : '' }}">
                    <a class="nav-link" href="{{ route('warehouse.confirm_delivery_order') }}"><span>Confirm Delivery Order</span></a>
                </li>
            </ul>
        </li>
        <li class="dropdown {{ request()->segment(1) == 'finance' ? ' active' : '' }}">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-chart-line"></i><span>Finance</span></a>
            <ul class="dropdown-menu">
                <li class="{{ request()->route()->getName() == 'finance.form_invoice_order' ? ' active' : '' }}">
                    <a class="nav-link" href="{{ route('finance.form_invoice_order') }}"><span>Form Invoice Order</span></a>
                </li>
            </ul>
        </li>
