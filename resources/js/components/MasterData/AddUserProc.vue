                ...
                <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input v-bind:class="{'is-invalid': errors.name}" type="text" v-model="name"
                                   class="form-control" placeholder="Full name of the user.">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <select class="form-control" v-model="bank" v-bind:class="{'is-invalid': errors.bank}">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <select class="form-control" v-model="origin" v-bind:class="{'is-invalid': errors.origin}">
                                <option v-for="origin in origins" v-bind:value="origin.id">{{ origin.description }}
                                </option>
                            </select>
        ...
        methods: {
            getData() {
                axios.all([
                    ...
                    axios.get(this.$parent.MakeUrl('api/v1/master_data/category')),
                    axios.get(this.$parent.MakeUrl('api/v1/master_data/origin')),
                ]).then(axios.spread((bank, category, origin) => {
