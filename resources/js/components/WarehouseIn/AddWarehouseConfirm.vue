        ...
        <div class="row" v-else>
            ...
            <div class="col-md-3" v-if="procurementId !== ''">
                <div class="form-group">
                    ...
                    <div>
                        <input type="text" class="form-control" v-model="procurement.proc_name" disabled/>
                    </div>
                </div>
            </div>
            <!--File-->
                ...
                <div class="table-responsive m-t-40" style="clear: both;">
                    <table class="table table-hover" id="contentTable" style="font-size: 9pt;">
                        ...
                        <tr v-for="(item, index) in procurement.items" v-bind:key="index">
                            ...
                            <td>
                                <input v-model="item.qty_minus" type="number" class="form-control"/>
                            </td>
                        </tr>
                        </tbody>
                    </table>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getProcurement() {
                this.loading = true;
                axios.get(this.$parent.MakeUrl("api/v1/procurement/show/" + this.procurementId)).then(res => {
