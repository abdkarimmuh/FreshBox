    ...
    <div>
        ...
        <div id="printMe" v-if="loading">
            <div
                ...
                v-for="(item, index) in invoice_order"
            >
        ...
        <div
            v-if="loading & !invoice_order.length"
    ...
    methods: {
        getData() {
            ...
            axios
                .get(
                    this.$parent.MakeUrl(
                        "api/v1/finance/invoice_order/show?printAll=true"
                    )
                )
                .then(res => {
        ...
        async print() {
            ...
            Vue.swal({
                ...
                if (result.value) {
                    ...
                    axios.post(
                        this.$parent.MakeUrl(
                            "api/v1/finance/invoice_order/print?printAll=true"
                        )
                    );
                }
            });
