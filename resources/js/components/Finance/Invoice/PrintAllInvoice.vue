    ...
    export default {
        ...
        methods: {
            getData() {
                ...
                axios.get(this.$parent.MakeUrl('api/v1/finance/invoice_order/show?printAll=true'))
                    .then(res => {
            ...
            async print() {
                ...
                Vue.swal({
                    ...
                    if (result.value) {
                        ...
                        axios.post(this.$parent.MakeUrl('api/v1/finance/invoice_order/print?printAll=true'));
                    }
                })
