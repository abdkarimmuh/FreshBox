      ...
      >
        <div class="col-md-12">
          <div class="pull-right text-right">
            <address>
              <h4><b class="text-danger">{{ title }} <span class="pull-right">#{{ sales_order.sales_order_no }}</span></b></h4>
...
export default {
  ...
  methods: {
    getData () {
      axios.get(this.$parent.MakeUrl('admin/marketing/form_sales_order/' + this.id + '/pdf'))
        .then(res => {
