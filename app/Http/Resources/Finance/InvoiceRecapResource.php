...
class InvoiceRecapResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'paid_date' => isset($this->paid_date) ? $this->paid_date->formatLocalized('%d %B %Y') : null,
            'submitted_date' => isset($this->submitted_date) ? $this->submitted_date->formatLocalized('%d %B %Y') : null,
